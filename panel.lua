...
radiusLabel.Position=UDim2.new(0.3,0,0.45,0)
radiusLabel.BackgroundTransparency=1
radiusLabel.Text="Rad: 15"
...
radiusMinus.Position=UDim2.new(0.1,0,0.45,0)
...
radiusPlus.Position=UDim2.new(0.72,0,0.45,0)
...
speedLabel.Position=UDim2.new(0.3,0,0.7,0)
...
speedMinus.Position=UDim2.new(0.1,0,0.7,0)
...
speedPlus.Position=UDim2.new(0.72,0,0.7,0)
...
speedMinus.MouseButton1Click:Connect(function()
    rotationSpeed=math.max(0.1,rotationSpeed-5)
    if rotationSpeed<0.1 then rotationSpeed=0.1 end
    speedLabel.Text="Spd: "..rotationSpeed
end)
speedPlus.MouseButton1Click:Connect(function()
    rotationSpeed=math.min(50,rotationSpeed+5)
    speedLabel.Text="Spd: "..rotationSpeed
end)
